...
# Match at the beginning of the line 3 digits followed by -, capture the numbers, and wrap them in parens
sed 's/\b([A-Za-z0-9._%+-])+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/\1@starhealth.org/'
